package tw.edu.ntu.csie.libsvm.function;
...
import tw.edu.ntu.csie.libsvm.model.svm_print_interface;
...
public class svm_train {
	...
	/**
	 * Save svm model after training.
	 * @author xiaoxiao
	 * */
	public svm_train(svm_parameter param, svm_problem prob, String model_file_name) throws IOException{
		this.param = param;
		this.prob = prob;
	...
	public svm_parameter getSvmParam(String[] argv){
		int i;
		svm_print_interface print_func = null; // default printing to stdout
