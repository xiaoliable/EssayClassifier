...
/**
 <p>Kernel evaluation
 <p>the static method k_function is for doing single kernel evaluation
...
abstract class Kernel extends QMatrix {
	...
	/**
	 * Four kernel function calculations.
	 * */
...
/**
 *<p> An SMO algorithm in Fan et al., JMLR 6(2005), p. 1889--1918
 *<p>  Solves:
 *<p> 
 *<p> 	min 0.5(\alpha^T Q \alpha) + p^T \alpha
 *<p> 
 *<p> 		y^T \alpha = \delta
 *<p> 		y_i = +1 or -1
 *<p> 		0 <= alpha_i <= Cp for y_i = 1
 *<p> 		0 <= alpha_i <= Cn for y_i = -1
 *<p> 
 *<p>  Given:
 *<p> 
 *<p> 	Q, p, y, Cp, Cn, and an initial feasible point \alpha
 *<p> 	l is the size of vectors and matrices
 *<p> 	eps is the stopping tolerance
 *<p> 
...
//		svm_print_string.print(s);
	...
	// Interface functions
	//
	public static SvmModel svm_train(svm_problem prob, svm_parameter param)
	{
	 ...
	 * select the svm type.
	 * */
	public static double svm_predict_values(SvmModel model, svm_node[] x, double[] dec_values)
	{
		int i;
...
//				System.out.print("vote[ "+ j +" ] = " + vote[j] + "\t");
//			}
//			System.out.println("vote[vote_max_idx] = " + vote_max_idx);
	 ...
	 * select the svm type.
	 * */
	public static double svm_predict(SvmModel model, svm_node[] x)
	{
		int nr_class = model.nr_class;
		double[] dec_values;
		if(model.param.svm_type == svm_parameter.ONE_CLASS ||
	...
	public static double svm_predict_probability(SvmModel model, svm_node[] x, double[] prob_estimates)
	{
	...
	public static boolean read_model_header(BufferedReader fp, SvmModel model)
	{
